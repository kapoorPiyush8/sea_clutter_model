class _NRLModel:
    ...
    #wind speed is not a direct contributor in NRL model. 
    ...
    def sigma0(self, grazing_deg: float, sea_state: float,
               ...
               pol: Literal['HH', 'VV']) -> float:
                   ...
                   """compute sigma in dB.
                   Note: wind speed is not a direct input to NRL model. the conversion happens upstream i.e., wind speed is derived from SS
                   """
        ...
        alpha = 0.0   # upwind baseline aspect handled by Kd parameter
